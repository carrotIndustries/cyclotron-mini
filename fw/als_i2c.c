...
#define SCL_BIT ALS_SCL
#define SDA_BIT ALS_SDA

#define SDA_OUT ALS_OUT
#define SDA_IN  ALS_IN
#define SDA_DIR ALS_DIR

#define SCL_OUT ALS_OUT
#define SCL_IN  ALS_IN
#define SCL_DIR ALS_DIR
...
uint8_t als_i2c_write_byte( uint8_t          send_start ,
                     uint8_t          send_stop  ,
                     uint8_t byte         ) 
{
  uint8_t     nack;
